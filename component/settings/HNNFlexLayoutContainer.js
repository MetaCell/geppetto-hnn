...
class HNNFlexLayoutContainer extends Component {
  ...
  factory (node) {
    ...
    if (component === "DipoleIframe" ) {
      ...
      node.setEventListener("close", () => {
        this.setState({ dipoleIframeVisible: false, });
      });
      return (
    ...
    if (component === "TracesIframe" ) {
      ...
      node.setEventListener("close", () => {
        this.setState({ tracesIframeVisible: false, });
      });
      return (
        <div style={{ width: '100%', height: '100%', textAlign: "center" }}>
    ...
    if (component === "PSDIframe" ) {
      ...
      node.setEventListener("close", () => {
        this.setState({ psdIframeVisible: false, });
      });
      return (
        <div style={{ width: '100%', height: '100%', textAlign: "center" }}>
    ...
    if (component === "RasterIframe" ) {
      ...
      node.setEventListener("close", () => {
        this.setState({ rasterIframeVisible: false, });
      });
      return (
        <div style={{ width: '100%', height: '100%', textAlign: "center" }}>
    ...
    if (component === "SpectrogramIframe" ) {
      ...
      node.setEventListener("close", () => {
        this.setState({ spectrogramIframeVisible: false, });
      });
  ...
  dipoleHandler () {
    ...
    this.setState({ dipoleIframeVisible: true })
  }
